...
public class TestPolicyEndorsementDeclineByCompany extends BaseTest implements CustomerContext, CaseProfileContext, GroupAccidentMasterPolicyContext {
    ...
    public void testPolicyEndorsementDeclineByCompany() {
        ...
        groupAccidentMasterPolicy.declineByCompanyQuote().perform(groupAccidentMasterPolicy.getDefaultTestData(TestDataKey.DECLINE_BY_COMPANY, TestDataKey.DEFAULT_TEST_DATA_KEY));
        PolicySummaryPage.buttonPendedEndorsement.click();
