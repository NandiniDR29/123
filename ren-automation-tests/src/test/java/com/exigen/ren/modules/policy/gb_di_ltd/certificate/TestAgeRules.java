...
import static com.exigen.ren.main.modules.policy.gb_di_ltd.certificate.metadata.InsuredTabMetaData.GENERAL_INFORMATION;
import static com.exigen.ren.main.modules.policy.gb_di_ltd.certificate.metadata.InsuredTabMetaData.GeneralInformationMetaData.DATE_OF_BIRTH;
...
public class TestAgeRules extends BaseTest implements CustomerContext, CaseProfileContext, LongTermDisabilityCertificatePolicyContext, LongTermDisabilityMasterPolicyContext {
    ...
    public void testAgeRulesForPrimaryParticipant() {
        ...
        TestData tdCertificatePolicy = longTermDisabilityCertificatePolicy.getDefaultTestData(TestDataKey.DATA_GATHER, TestDataKey.DEFAULT_TEST_DATA_KEY);
        longTermDisabilityCertificatePolicy.initiate(tdCertificatePolicy);
        ...
        Tab.buttonNext.click();
        LongTermDisabilityCertificatePolicyContext.premiumSummaryTab.fillTab(tdCertificatePolicy).submitTab();
        ...
        longTermDisabilityCertificatePolicy.dataGather().start();
        ...
        Tab.buttonNext.click();
        coveragesTab.fillTab(tdCertificatePolicy);
        assertThat(coveragesTab.getAssetList().getAsset(CoveragesTabMetaData.ROLE_NAME)).hasValue("Primary Participant");
        Tab.buttonNext.click();
        ...
        longTermDisabilityCertificatePolicy.issue().perform(
                tdCertificatePolicy.adjust(longTermDisabilityCertificatePolicy.getDefaultTestData(ISSUE, TestDataKey.DEFAULT_TEST_DATA_KEY)).resolveLinks());
