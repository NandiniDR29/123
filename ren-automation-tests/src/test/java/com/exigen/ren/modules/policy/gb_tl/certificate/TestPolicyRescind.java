...
public class TestPolicyRescind extends BaseTest implements CustomerContext, CaseProfileContext, TermLifeInsuranceCertificatePolicyContext, TermLifeInsuranceMasterPolicyContext {
    ...
    public void testPolicyRescindCancellation() {
        ...
        termLifeInsuranceCertificatePolicy.cancel().perform(termLifeInsuranceCertificatePolicy.getDefaultTestData(TestDataKey.CANCELLATION, "TestData_Plus2Months"));
        ...
        termLifeInsuranceCertificatePolicy.rescindCancellation().perform(termLifeInsuranceCertificatePolicy.getDefaultTestData(TestDataKey.RESCIND_CANCELLATION, TestDataKey.DEFAULT_TEST_DATA_KEY));
    ...
    public void testRollBackPolicyRescindCancellation() {
        ...
        termLifeInsuranceCertificatePolicy.endorse().perform(termLifeInsuranceCertificatePolicy.getDefaultTestData(TestDataKey.ENDORSEMENT, "TestData_Plus3Months"));

        String endorseEffectiveDate = termLifeInsuranceCertificatePolicy.getDefaultTestData(TestDataKey.ENDORSEMENT, "TestData_Plus3Months").getValue(StartEndorsementActionTab.class.getSimpleName(),
        ...
        LOGGER.info("TEST: Cancelling Policy #" + policyNumber);
        termLifeInsuranceCertificatePolicy.cancel().start();
        Page.dialogConfirmation.confirm();
        termLifeInsuranceCertificatePolicy.cancel().getWorkspace().fill(termLifeInsuranceCertificatePolicy.getDefaultTestData(TestDataKey.CANCELLATION, "TestData_Plus2Months"));
        termLifeInsuranceCertificatePolicy.cancel().submit();
        assertThat(PolicySummaryPage.labelPolicyStatus).hasValue(ProductConstants.PolicyStatus.CANCELLATION_PENDING);
        assertThat(NavigationPage.comboBoxListAction.isOptionPresent(ActionConstants.ProductAction.CANCELLATION)).isFalse();
