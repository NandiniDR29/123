...
public class TestDiscardBillSelfAdmin extends GroupBenefitsBillingBaseTest implements BillingAccountContext {

    @Test(groups = {BILLING_GB, REGRESSION, WITHOUT_TS})
    @TestInfo(testCaseId = "IPBQA-24787", component = BILLING_GROUPBENEFITS)
    public void testDiscardBillSelfAdmin() {
        ...
        discardedBillVerificationForSelfAdmin();
    }
}
