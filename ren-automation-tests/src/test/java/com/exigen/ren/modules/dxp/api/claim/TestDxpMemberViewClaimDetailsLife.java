...
import com.exigen.ren.rest.dxp.model.claim.claimsMemberModels.claimsTermLifeMemberModels.DamageModel;
...
public class TestDxpMemberViewClaimDetailsLife extends RestBaseTest implements CaseProfileContext,
    ...
    @TestInfo(testCaseId = "REN-38715", component = CUSTOMER_REST)
    public void testDxpMemberViewClaimDetailsLife() {
        mainApp().open();
        ...
        LOGGER.info("Step 1");
        assertSoftly(softly -> {
            ResponseContainer<ClaimsTermLifeMemberClaimsModel> response = dxpRestService.getMemberClaimsTermLife(customerNumIC, claimNumber);
        ...
        LOGGER.info("Step 2");
        assertSoftly(softly -> {
            ResponseContainer<ClaimsTermLifeMemberClaimsModel> response = dxpRestService.getMemberClaimsTermLife(customerNumNIC, claimNumber);
