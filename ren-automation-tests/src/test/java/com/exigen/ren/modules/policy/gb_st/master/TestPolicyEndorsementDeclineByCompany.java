...
public class TestPolicyEndorsementDeclineByCompany extends BaseTest implements CustomerContext, CaseProfileContext, StatutoryDisabilityInsuranceMasterPolicyContext {
    ...
    public void testPolicyEndorsementDeclineByCompany() {
        ...
        statutoryDisabilityInsuranceMasterPolicy.endorse().perform(statutoryDisabilityInsuranceMasterPolicy.getDefaultTestData(TestDataKey.ENDORSEMENT, TestDataKey.DEFAULT_TEST_DATA_KEY));
        PolicySummaryPage.buttonPendedEndorsement.click();

        statutoryDisabilityInsuranceMasterPolicy.declineByCompanyQuote().perform(statutoryDisabilityInsuranceMasterPolicy.getDefaultTestData(TestDataKey.DECLINE_BY_COMPANY, TestDataKey.DEFAULT_TEST_DATA_KEY));
        PolicySummaryPage.buttonPendedEndorsement.click();
