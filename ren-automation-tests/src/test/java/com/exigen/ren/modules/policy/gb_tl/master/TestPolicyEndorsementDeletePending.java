...
public class TestPolicyEndorsementDeletePending extends BaseTest implements CustomerContext, CaseProfileContext, TermLifeInsuranceMasterPolicyContext {

    @Test(groups = {GB, GB_PRECONFIGURED, GB_TL, WITHOUT_TS, REGRESSION})
    @TestInfo(testCaseId = {"IPBQA-24491", "REN-27898"}, component = POLICY_GROUPBENEFITS)
    public void testPolicyEndorsementDeletePending() {
        ...
        assertSoftly(softly -> {
            ...
            LOGGER.info("REN-27898 Step 2");
            AbstractContainer<?, ?> assetListForStartEndorsementActionTab = termLifeInsuranceMasterPolicy.endorse().getWorkspace().getTab(StartEndorsementActionTab.class).getAssetList();
            ...
            termLifeInsuranceMasterPolicy.deletePendedTransaction().perform(new SimpleDataProvider());
