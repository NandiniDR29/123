...
public class TestDiscardBillFullAdmin extends GroupBenefitsBillingBaseTest implements BillingAccountContext {
    @Test(groups = {BILLING_GB, REGRESSION, WITHOUT_TS})
    @TestInfo(testCaseId = "IPBQA-24777", component = BILLING_GROUPBENEFITS)
    public void testDiscardBillFullAdmin() {
        ...
        discardedBillVerificationForFullAdmin();
    }
}
