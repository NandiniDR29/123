...
public class TestPremiumBilledButNotEarnedSubledger extends GroupBenefitsBillingBaseTest implements BillingAccountContext {

    @Test(groups = {BILLING_GB, REGRESSION, WITH_TS})
    @TestInfo(testCaseId = "REN-34570", component = BILLING_GROUPBENEFITS)
    public void testPremiumBilledButNotEarnedSubledgerSelf() {
        ...
        TestData td = groupAccidentMasterPolicy.getDefaultTestData(DATA_GATHER_SELF_ADMIN, "TestData_WithTwoCoverages")
