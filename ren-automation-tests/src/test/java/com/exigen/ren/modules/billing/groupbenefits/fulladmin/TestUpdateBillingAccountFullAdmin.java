...
public class TestUpdateBillingAccountFullAdmin extends GroupBenefitsBillingBaseTest implements BillingAccountContext {

    @Test(groups = {BILLING_GB, REGRESSION, WITHOUT_TS})
    @TestInfo(testCaseId = "IPBQA-24781", component = BILLING_GROUPBENEFITS)
