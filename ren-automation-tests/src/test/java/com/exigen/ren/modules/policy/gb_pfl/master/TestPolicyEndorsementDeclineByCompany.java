...
public class TestPolicyEndorsementDeclineByCompany extends BaseTest implements CustomerContext, CaseProfileContext, PaidFamilyLeaveMasterPolicyContext {
    ...
    public void testPolicyEndorsementDeclineByCompany() {
        ...
        paidFamilyLeaveMasterPolicy.declineByCompanyQuote().perform(paidFamilyLeaveMasterPolicy.getDefaultTestData(TestDataKey.DECLINE_BY_COMPANY, TestDataKey.DEFAULT_TEST_DATA_KEY));
        PolicySummaryPage.buttonPendedEndorsement.click();
