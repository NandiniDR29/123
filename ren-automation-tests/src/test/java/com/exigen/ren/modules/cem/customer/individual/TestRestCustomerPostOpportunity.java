...
public class TestRestCustomerPostOpportunity extends RestBaseTest {
    ...
    private void checkOpportunity(OpportunityModel opportunityModel) {
        ...
        assertSoftly(softly -> {
            ...
            softly.assertThat(generalInformation.getAsset(OpportunityActionTabMetaData.STATUS).getValue().toUpperCase()).isEqualTo(opportunityModel.getStatus());
            softly.assertThat(generalInformation.getAsset(OpportunityActionTabMetaData.REFERRED_BY.getLabel(), StaticElement.class))
                    .hasValue(opportunityModel.getReferral().getDisplayValue());
            softly.assertThat(generalInformation.getAsset(OpportunityActionTabMetaData.OPPORTUNITY_OWNER.getLabel(), StaticElement.class))
