...
public class TestPolicyCancellationMidTerm extends BaseTest implements CustomerContext, CaseProfileContext, GroupAccidentMasterPolicyContext {
    ...
    public void testPolicyCancellationMidTerm() {
        ...
        groupAccidentMasterPolicy.createPolicy(getDefaultACMasterPolicyData()
                .adjust(groupAccidentMasterPolicy.getDefaultTestData(TestDataKey.DATA_GATHER, "Adjustment_BackDated").resolveLinks()));
