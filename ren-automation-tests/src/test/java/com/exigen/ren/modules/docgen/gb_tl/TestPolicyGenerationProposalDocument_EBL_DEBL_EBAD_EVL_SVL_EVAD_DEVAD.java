...
public class TestPolicyGenerationProposalDocument_EBL_DEBL_EBAD_EVL_SVL_EVAD_DEVAD extends ValidationXMLBaseTestTL implements CustomerContext, CaseProfileContext, TermLifeInsuranceMasterPolicyContext {
    ...
    @TestInfo(testCaseId = "REN-20391", component = POLICY_GROUPBENEFITS)
    public void testPolicyGenerationProposalDocument() {
        ...
        validateClassificationVL_Spouse(xmlValidator);

        LOGGER.info("TEST: Validate classificationItems_VADD_Employee section");
        validateClassificationVADD_Employee(xmlValidator, groupNameFirst);
        validateClassificationVADD_Employee(xmlValidator, groupNameSecond);

        LOGGER.info("TEST: Validate classificationItems_VADD_Dependent section");
        validateClassificationVADD_Dependent(xmlValidator, groupNameFirst);
        validateClassificationVADD_Dependent(xmlValidator, groupNameSecond);
        ...
        LOGGER.info("TEST: Validate benefitDetailsInfos_DVL");
        getBenefitDetailsInfoDVLSection(xmlValidator, policyNumber, BASIC_LIFE_PLAN, CoveragesConstants.TermLifeCoveragesId.SP_VOL_BTL, groupNameFirst)
                .checkDocument(tdSpecific().getTestData("TestData_DVL"));
        ...
        LOGGER.info("TEST: Validate benefitDetailsInfos_VADD for group=" + groupNameFirst);
        getBenefitDetailsInfoVADDSection(xmlValidator, policyNumber, BASIC_LIFE_PLAN, CoveragesConstants.TermLifeCoveragesId.VOL_ADD, groupNameFirst)
                .checkDocument(tdSpecific().getTestData("TestData_VADD"));

        LOGGER.info("TEST: Validate dependentAgeReductions LIFE132");
        assertThat(getDependentAgeReductionsBenefitDetailsInfoVADDSection(xmlValidator, policyNumber, BASIC_LIFE_PLAN,
                CoveragesConstants.TermLifeCoveragesId.VOL_ADD, groupNameFirst))
                .containsSequence("Age 65 reduces to 65%", "Age 70 reduces to 50%");

        LOGGER.info("TEST: Validate ageReductions LIFE131");
        assertThat(getAgeReductionsBenefitDetailsInfoVADDSection(xmlValidator, policyNumber, BASIC_LIFE_PLAN,
                CoveragesConstants.TermLifeCoveragesId.VOL_ADD, groupNameFirst))
                .containsSequence("N/A");

        LOGGER.info("TEST: Validate benefitDetailsInfos_VADD for group=" + groupNameSecond);
        getBenefitDetailsInfoVADDSection(xmlValidator, policyNumber, BASIC_LIFE_PLAN, CoveragesConstants.TermLifeCoveragesId.VOL_ADD, groupNameSecond)
                .checkDocument(tdSpecific().getTestData("TestData_VADD"));
        ...
        mapAgeBandedInfoSection_VL.put(LIFE153_1_1, "true");
        ...
        LOGGER.info("TEST: Validate benefitDetailsInfos_DVL(Life150-Life153)");
        ...
        mapAgeBandedInfoSection_DVL.put(LIFE153_1_1, "true");
        mapAgeBandedInfoSection_DVL.put(LIFE155_1, "false");
        mapAgeBandedInfoSection_DVL.put(LIFE156_1, "true");
        mapAgeBandedInfoSection_DVL.put(LIFE156_2, String.format("$%s Per $1,000 regardless of the number of children",
                getValuesFromClassificationManagement(DEP_VOL_ADD, groupNameFirst).get(TableConstants.CoverageRelationships.RATE.getName())));
        ...
        LOGGER.info("TEST: Validate ageBandedInfoItems");
        validateAgeBandedInfoItems_DVL(xmlValidator, policyNumber);
    }
    ...
    private void validateClassificationVL_Spouse(XmlValidator xmlValidator) {
        classificationManagementMpTab.navigateToTab();
        Map<String, String> mapValuesFromPlanDefinition = getValuesFromClassificationManagement(SP_VOL_BTL, groupNameFirst);
        premiumSummaryTab.navigateToTab();
        Currency modalPremium = getCommonModalPremiumByPair(SP_VOL_BTL);

        Map<DocGenEnum.AllSections, String> mapClassificationVL_EmployeeSection = new HashMap<>();
        mapClassificationVL_EmployeeSection.put(LIFE27, groupNameFirst);
        ...
        getClassificationVL_SpouseSection(xmlValidator, policyNumber, BASIC_LIFE_PLAN, groupNameFirst).checkDocument(mapClassificationVL_EmployeeSection);
    }

    private void validateClassificationVADD_Employee(XmlValidator xmlValidator, String groupName) {
        classificationManagementMpTab.navigateToTab();
        Map<String, String> mapValuesFromPlanDefinition = getValuesFromClassificationManagement(VOL_ADD, groupName);
        premiumSummaryTab.navigateToTab();
        Currency modalPremium = getModalPremiumByClassName(VOL_ADD, groupName);

        Map<DocGenEnum.AllSections, String> mapClassificationVADD_EmployeeSection = new HashMap<>();
        mapClassificationVADD_EmployeeSection.put(LIFE37, groupName);
        mapClassificationVADD_EmployeeSection.put(LIFE38,
                mapValuesFromPlanDefinition.get(TableConstants.CoverageRelationships.NUMBER_OF_PARTICIPANTS.getName()));
        mapClassificationVADD_EmployeeSection.put(LIFE39_2,
                mapValuesFromPlanDefinition.get(TableConstants.CoverageRelationships.TOTAL_VOLUME.getName()));
        mapClassificationVADD_EmployeeSection.put(LIFE40_1, "false");
        mapClassificationVADD_EmployeeSection.put(LIFE40_2,
                mapValuesFromPlanDefinition.get(TableConstants.CoverageRelationships.RATE.getName()));
        mapClassificationVADD_EmployeeSection.put(LIFE40_3, "Per $1,000");
        mapClassificationVADD_EmployeeSection.put(LIFE41, modalPremium.toPlainString());

        getClassificationVADD_EmployeeSection(xmlValidator, policyNumber, BASIC_LIFE_PLAN, groupName).checkDocument(mapClassificationVADD_EmployeeSection);
    }

    private void validateClassificationVADD_Dependent(XmlValidator xmlValidator, String groupName) {
        classificationManagementMpTab.navigateToTab();
        Map<String, String> mapValuesFromPlanDefinition = getValuesFromClassificationManagement(DEP_VOL_ADD, groupName);
        premiumSummaryTab.navigateToTab();
        Currency modalPremium = getModalPremiumByClassName(DEP_VOL_ADD, groupName);

        Map<DocGenEnum.AllSections, String> mapClassificationVADD_DependentSection = new HashMap<>();
        mapClassificationVADD_DependentSection.put(LIFE42, groupName);
        mapClassificationVADD_DependentSection.put(LIFE43,
                mapValuesFromPlanDefinition.get(TableConstants.CoverageRelationships.NUMBER_OF_PARTICIPANTS.getName()));
        mapClassificationVADD_DependentSection.put(LIFE44_2,
                mapValuesFromPlanDefinition.get(TableConstants.CoverageRelationships.TOTAL_VOLUME.getName()));
        mapClassificationVADD_DependentSection.put(LIFE45_1, "false");
        mapClassificationVADD_DependentSection.put(LIFE45_2,
                mapValuesFromPlanDefinition.get(TableConstants.CoverageRelationships.RATE.getName()));
        mapClassificationVADD_DependentSection.put(LIFE45_3, "Per $1,000");
        mapClassificationVADD_DependentSection.put(LIFE46, modalPremium.toPlainString());

        getClassificationVADD_DependentSection(xmlValidator, policyNumber, BASIC_LIFE_PLAN, groupName).checkDocument(mapClassificationVADD_DependentSection);
    }
    ...
    private void validateAgeBandedInfoItems_VL(XmlValidator xmlValidator, String policyNumber) {
        ...
        String proposedRateSubGroup = tableClassificationSubGroupsAndRatingInfo.getRow(1)
                .getCell(RATE.getName()).getValue();
        coveragesTable.getRow(PolicyConstants.PolicyGroupCoveragesTable.COVERAGE_NAME, VOL_ADD).getCell(PolicyConstants.PolicyGroupCoveragesTable.COVERAGE_NAME).click();
        String proposedRateADD = new StaticElement(COMMON_LOCATOR_GET_VALUE_BY_LABEL.format("Proposed Rate")).getValue();
        ...
        mapAgeBandedInfoSection.put(LIFE153_1_3, formatProposedRate(proposedRateADD));
    ...
    private void validateAgeBandedInfoItems_DVL(XmlValidator xmlValidator, String policyNumber) {
        ...
        String proposedRateSubGroup = tableClassificationSubGroupsAndRatingInfo.getRow(1)
                .getCell(RATE.getName()).getValue();
        coveragesTable.getRow(PolicyConstants.PolicyGroupCoveragesTable.COVERAGE_NAME, DEP_VOL_ADD).getCell(PolicyConstants.PolicyGroupCoveragesTable.COVERAGE_NAME).click();
        String proposedRateADD = new StaticElement(COMMON_LOCATOR_GET_VALUE_BY_LABEL.format("Proposed Rate")).getValue();
        ...
        getAgeBandedInfoDVLSection(xmlValidator, policyNumber, BASIC_LIFE_PLAN, CoveragesConstants.TermLifeCoveragesId.SP_VOL_BTL, groupNameFirst, "Under 25")
