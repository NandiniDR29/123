...
public class TestCheckNotePaymentReissuedForPayment extends ClaimGroupBenefitsLTDBaseTest {
    ...
    public void testCheckPaymentReissuePaymentWithBalance() {
        ...
        disabilityClaim.create(disabilityClaim.getLTDTestData().getTestData(DATA_GATHER, "TestData_WithOneBenefit")
                .adjust(makeKeyPath(policyInformationParticipantParticipantInformationTab.getMetaKey(), COVERED_EARNINGS.getLabel()), "250")
        ...
        disabilityClaim.claimUpdate().perform(tdClaim.getTestData("TestClaimUpdate", "TestData_Update")
                .adjust(makeKeyPath(PolicyInformationParticipantParticipantInformationActionTab.class.getSimpleName(), COVERED_EARNINGS.getLabel()), "200"));
