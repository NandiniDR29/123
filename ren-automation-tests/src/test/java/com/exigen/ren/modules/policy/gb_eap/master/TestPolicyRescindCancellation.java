...
public class TestPolicyRescindCancellation extends BaseTest implements CustomerContext, CaseProfileContext, EmployeeAssistanceProgramMasterPolicyContext {
    ...
    public void testPolicyRescindCancellation() {
        ...
        employeeAssistanceProgramMasterPolicy.cancel().perform(employeeAssistanceProgramMasterPolicy.getDefaultTestData(TestDataKey.CANCELLATION, "TestData_Plus2Months"));
        ...
        String cancelEffectiveDate = employeeAssistanceProgramMasterPolicy.getDefaultTestData(TestDataKey.CANCELLATION, "TestData_Plus2Months")
        ...
        employeeAssistanceProgramMasterPolicy.rescindCancellation().perform(employeeAssistanceProgramMasterPolicy.getDefaultTestData(RESCIND_CANCELLATION, DEFAULT_TEST_DATA_KEY));
