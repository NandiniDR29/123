...
public class TestCheckNotePaymentReissuedForPayment extends ClaimGroupBenefitsACBaseTest {
    ...
    public void testCheckNotePaymentReissuedForPayment() {
        ...
        assertSoftly(softly -> {
            softly.assertThat(ClaimPaymentsPage.tablePaymentStatusHistory.getRow(3).getCell(STATUS.getName())).hasValue("Declined");
            softly.assertThat(ClaimPaymentsPage.tablePaymentStatusHistory.getRow(3).getCell(DETAILS.getName())).hasValue("Payment Reissued");
        });
