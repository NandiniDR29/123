...
public class TestRestCustomerPutRelationship extends RestBaseTest {
    ...
    public void testRestCustomerPutRelationship() {
        ...
        putRelationship(customerNumber, relationshipModels.get(0), "Child - Daughter");
        putRelationship(customerNumber, relationshipModels.get(1), "Colleague");
        ...
        assertThat(actualRelationships.stream().filter(text -> text.contains("Individual") && text.contains("Child - Daughter"))).hasSize(1);
        assertThat(actualRelationships.stream().filter(text -> text.contains("Non-Individual") && text.contains("Colleague"))).hasSize(1);
    }
