...
public class TestClaimVerifyCoveredEarningsField extends ClaimGroupBenefitsSTDBaseTest {
    ...
    public void testClaimVerifyCoveredEarningsField() {
        ...
        disabilityClaim.getDefaultWorkspace().fillFromTo(disabilityClaim.getSTDTestData().getTestData(TestDataKey.DATA_GATHER, TestDataKey.DEFAULT_TEST_DATA_KEY),
