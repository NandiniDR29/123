...
public class TestPolicyRewriteToNewNumber extends BaseTest implements CustomerContext, CaseProfileContext, GroupDentalMasterPolicyContext {
    ...
    public void testPolicyRewriteToNewNumber() {
        ...
        groupDentalMasterPolicy.createRewrite(groupDentalMasterPolicy.getDefaultTestData(TestDataKey.REWRITE, "TestDataNewNumber")
        ...
        String policyEffectiveDateRewritten = groupDentalMasterPolicy.getDefaultTestData(TestDataKey.REWRITE, "TestDataNewNumber").getValue(RewriteActionTab.class.getSimpleName(),
