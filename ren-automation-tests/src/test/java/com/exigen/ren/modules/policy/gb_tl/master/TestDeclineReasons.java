...
public class TestDeclineReasons extends ScenarioTestDeclineReasons implements TermLifeInsuranceMasterPolicyContext {

    @Test(groups = {GB, GB_PRECONFIGURED, GB_TL, WITHOUT_TS, REGRESSION})
    @TestInfo(testCaseId = {"REN-27998"}, component = POLICY_GROUPBENEFITS)
    public void testDeclineReasons() {
        super.testDeclineReasons(GroupBenefitsMasterPolicyType.GB_TL, getDefaultTLMasterPolicyData());
    }
}
