...
public class TestSynchronizeInClaimAddressFields extends ClaimGroupBenefitsACBaseTest {
    ...
    public void testSynchronizeInClaimAddressFields() {
        ...
        TestData tdClaimCreation = accHealthClaim.getGbACTestData().getTestData(DATA_GATHER, DEFAULT_TEST_DATA_KEY);
