...
public class TestClaimPaymentCalculationForRehabilitationBenefit extends ClaimGroupBenefitsLTDBaseTest {
    ...
    public void testClaimPaymentCalculationRIBNotIncludedInPolicy() {
        ...
        disabilityClaim.addBenefit().getWorkspace().fill(tdClaim.getTestData("NewBenefit", "TestData_LTD_OtherValues")
                .mask(TestData.makeKeyPath(BenefitLTDInjuryPartyInformationTab.class.getSimpleName(), ASSOCIATE_POLICY_PARTY.getLabel()))
    ...
    public void testClaimPaymentCalculationRIBIncludedInPolicy() {
        ...
        claim.addBenefit().perform(tdClaim.getTestData("NewBenefit", "TestData_LTD")
                .adjust(TestData.makeKeyPath(BenefitLTDInjuryPartyInformationTab.class.getSimpleName(), COVERED_EARNINGS.getLabel()), "1000")
                .mask(TestData.makeKeyPath(BenefitCoverageEvaluationTab.class.getSimpleName(), INSURED_PERSON_COVERAGE_EFFECTIVE_DATE.getLabel())));
        ...
        assertSoftly(softly -> {
            ...
            softly.assertThat(paymentCalculatorTab.getAssetList().getAsset(PAYMENT_ADDITION).getAsset(MONTHLY_BENEFIT_AMOUNT)).hasValue(new Currency(60).toString());
