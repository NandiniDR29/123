...
public class TestPolicyEndorsementDeclineByCompany extends BaseTest implements CustomerContext, CaseProfileContext, TermLifeInsuranceMasterPolicyContext {
    ...
    public void testPolicyEndorsementDeclineByCompany() {
        ...
        termLifeInsuranceMasterPolicy.declineByCompanyQuote().perform(termLifeInsuranceMasterPolicy.getDefaultTestData(TestDataKey.DECLINE_BY_COMPANY, TestDataKey.DEFAULT_TEST_DATA_KEY));
        PolicySummaryPage.buttonPendedEndorsement.click();
