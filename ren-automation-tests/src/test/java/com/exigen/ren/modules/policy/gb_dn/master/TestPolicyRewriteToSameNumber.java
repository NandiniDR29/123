...
public class TestPolicyRewriteToSameNumber extends BaseTest implements CustomerContext, CaseProfileContext, GroupDentalMasterPolicyContext {
    ...
    public void testPolicyRewriteToSameNumber() {
        ...
        groupDentalMasterPolicy.createRewrite(groupDentalMasterPolicy.getDefaultTestData(TestDataKey.REWRITE, TestDataKey.DEFAULT_TEST_DATA_KEY)
                .adjust(groupDentalMasterPolicy.getDefaultTestData(TestDataKey.REWRITE, TestDataKey.DATA_GATHER).resolveLinks())
        ...
        String rewriteEffectiveDate = groupDentalMasterPolicy.getDefaultTestData(TestDataKey.REWRITE, TestDataKey.DEFAULT_TEST_DATA_KEY).getValue(RewriteActionTab.class.getSimpleName(),
