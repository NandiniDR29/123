...
public class TestPolicyRewriteToNewNumber extends BaseTest implements CustomerContext, CaseProfileContext, PaidFamilyLeaveMasterPolicyContext {
    ...
    public void testPolicyRewriteToNewNumber() {
        ...
        paidFamilyLeaveMasterPolicy.createRewrite(paidFamilyLeaveMasterPolicy.getDefaultTestData(TestDataKey.REWRITE, "TestDataNewNumber")
        ...
        String policyEffectiveDateRewritten = paidFamilyLeaveMasterPolicy.getDefaultTestData(TestDataKey.REWRITE, "TestDataNewNumber").getValue(RewriteActionTab.class.getSimpleName(),
        ...
        assertSoftly(softly -> {
            assertThat(NotesAndAlertsSummaryPage.activitiesAndUserNotes.getRow(1)).hasCellWithValue("Description", String.format(BamConstants.POLICY_EFFECTIVE_FROM_QUOTE, policyNumberRewritten, policyEffectiveDateRewritten));
