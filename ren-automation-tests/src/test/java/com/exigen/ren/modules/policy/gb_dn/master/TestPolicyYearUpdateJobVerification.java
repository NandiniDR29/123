...
public class TestPolicyYearUpdateJobVerification extends BaseTest implements CustomerContext, CaseProfileContext, GroupDentalMasterPolicyContext {
    ...
    private void masterPolicyCreation(LocalDateTime effectiveDate, LocalDateTime nextPolicyYearStartDate) {
        groupDentalMasterPolicy.createPolicyViaUI(getDefaultDNMasterPolicyData()
    ...
    private void performEndorsement(LocalDateTime endorsementDate) {
        groupDentalMasterPolicy.createEndorsement(groupDentalMasterPolicy.getDefaultTestData(TestDataKey.ENDORSEMENT, TestDataKey.DEFAULT_TEST_DATA_KEY)
                ...
                .adjust(groupDentalMasterPolicy.getDefaultTestData(TestDataKey.DATA_GATHER, "TestDataUpdateSomething").resolveLinks())
