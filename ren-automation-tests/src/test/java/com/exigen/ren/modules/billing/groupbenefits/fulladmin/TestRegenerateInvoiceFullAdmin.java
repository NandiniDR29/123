...
public class TestRegenerateInvoiceFullAdmin extends GroupBenefitsBillingBaseTest implements BillingAccountContext {
    @Test(groups = {BILLING_GB, REGRESSION, WITHOUT_TS})
    @TestInfo(testCaseId = "IPBQA-24779", component = BILLING_GROUPBENEFITS)
    public void testRegenerateInvoiceFullAdmin() {
        ...
        regeneratedBillVerificationForFullAdmin();
    }
}
