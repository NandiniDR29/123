...
public class TestCustomerParticipantEmploymentRemoveKeepHistory extends CustomerBaseTest {
    ...
    @TestInfo(testCaseId = "IPBQA-24888", component = CRM_CUSTOMER)
    public void testCustomerParticipantEmploymentRemoveKeepHistory() {
        ...
        customerNonIndividual.removeParticipantEmployment().perform(tdCustomerNonIndividual.getTestData("RemoveParticipant", "TestData").adjust(
        ...
        assertThat(EmployeeInfoTab.labelEmployeeInformationExpanded)
                .hasValue(String.format("Employee Information for %s %s Relationship (Deprecated: Participant was removed from group)", customerNumber, customerName));
    }
}
