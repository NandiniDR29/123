...
public class TestPolicyEndorsementDeclineByCustomer extends BaseTest implements CustomerContext, CaseProfileContext, GroupDentalMasterPolicyContext {
    ...
    public void testPolicyEndorsementDeclineByCustomer() {
        ...
        groupDentalMasterPolicy.declineByCustomerQuote().perform(groupDentalMasterPolicy.getDefaultTestData(TestDataKey.DECLINE_BY_CUSTOMER, TestDataKey.DEFAULT_TEST_DATA_KEY));
        PolicySummaryPage.buttonPendedEndorsement.click();
