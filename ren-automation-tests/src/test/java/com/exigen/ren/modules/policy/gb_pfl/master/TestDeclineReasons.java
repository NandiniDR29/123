...
public class TestDeclineReasons extends ScenarioTestDeclineReasons implements PaidFamilyLeaveMasterPolicyContext {
    ...
    public void testDeclineReasons() {
        super.testDeclineReasons(GroupBenefitsMasterPolicyType.GB_PFL, getDefaultPFLMasterPolicyData());
    }
