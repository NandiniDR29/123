...
import static com.exigen.ren.main.modules.policy.gb_di_std.masterpolicy.metadata.PlanDefinitionTabMetaData.SponsorParticipantFundingStructureMetaData.TAXABILITY;
...
public class TestClaimPaymentCalculationForRehabilitationBenefit extends ClaimGroupBenefitsSTDBaseTest {
    ...
    public void testClaimPaymentCalculationRIBNotIncludedInPolicy() {
        ...
        LOGGER.info("Step 2");
        disabilityClaim.addBenefit().getWorkspace().fill(tdClaim.getTestData("NewBenefit", "TestData_STD_OtherValues")
        ...
        claim.addPayment().getWorkspace().fillUpTo(tdClaim.getTestData("ClaimPayment", "TestData_IndemnityPayment")
                .adjust(TestData.makeKeyPath(PaymentPaymentPaymentAllocationTab.class.getSimpleName(), PAYMENT_THROUGH_DATE.getLabel()),
                        TimeSetterUtil.getInstance().getCurrentTime().plusDays(185).format(MM_DD_YYYY)), paymentCalculatorTab.getClass());
    ...
    public void testClaimPaymentCalculationRIBIncludedInPolicy() {
        ...
        shortTermDisabilityMasterPolicy.createPolicy(getDefaultSTDMasterPolicyData()
                .adjust(TestData.makeKeyPath(planDefinitionTab.getClass().getSimpleName() + "[1]", TAXABILITY.getLabel()), "Benefits Not Taxable")
        ...
        claim.addBenefit().perform(tdClaim.getTestData("NewBenefit", "TestData_STD_OtherValues")
                .adjust(TestData.makeKeyPath(BenefitSTDInjuryPartyInformationTab.class.getSimpleName(), COVERED_EARNINGS.getLabel()), "1000")  // не проставляется
                .adjust(TestData.makeKeyPath(BenefitCoverageEvaluationTab.class.getSimpleName(), APPROVED_THROUGH_DATE.getLabel()), "01/01/2050")
                .mask(TestData.makeKeyPath(BenefitCoverageEvaluationTab.class.getSimpleName(), INSURED_PERSON_COVERAGE_EFFECTIVE_DATE.getLabel())));
        ...
        claim.addPayment().getWorkspace().fillUpTo(tdClaim.getTestData("ClaimPayment", "TestData_IndemnityPayment")
                ...
                .adjust(TestData.makeKeyPath(PaymentPaymentPaymentAllocationTab.class.getSimpleName(), PAYMENT_THROUGH_DATE.getLabel()), BPStartDate.plusDays(6).format(MM_DD_YYYY)), paymentCalculatorTab.getClass());
        ...
        assertSoftly(softly -> {
            ...
            softly.assertThat(paymentCalculatorTab.getAssetList().getAsset(PAYMENT_ADDITION).getAsset(WEEKLY_BENEFIT_AMOUNT)).isPresent();
            ...
            paymentCalculatorTab.getAssetList().getAsset(PAYMENT_ADDITION).getAsset(THROUGH_DATE).setValue(BPStartDate.plusDays(6).format(MM_DD_YYYY));

            LOGGER.info("TEST: Step 21. Post Payment");
            softly.assertThat(paymentCalculatorTab.getAssetList().getAsset(PAYMENT_ADDITION).getAsset(WEEKLY_BENEFIT_AMOUNT)).hasValue(new Currency(60).toString());
        ...
        claim.createPaymentSeries().getWorkspace().fillUpTo(tdClaim.getTestData("ClaimPayment", "TestData_CreatePaymentSeries")
                ...
                .adjust(TestData.makeKeyPath(PaymentSeriesPaymentSeriesProfileActionTab.class.getSimpleName(), EXPIRATION_DATE.getLabel()), BPStartDate.plusMonths(1).plusDays(6).format(MM_DD_YYYY)), PaymentSeriesCalculatorActionTab.class);
        ...
        assertSoftly(softly -> {
            ...
            paymentSeriesCalculatorActionTab.getAssetList().getAsset(PaymentSeriesCalculatorActionTabMetaData.PAYMENT_ADDITION).getAsset(PaymentSeriesCalculatorActionTabMetaData.PaymentAdditionMetaData.THROUGH_DATE).setValue(BPStartDate.plusMonths(1).plusDays(6).format(MM_DD_YYYY));
