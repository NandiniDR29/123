...
public class TestPolicyRescind extends BaseTest implements CustomerContext, CaseProfileContext, GroupAccidentCertificatePolicyContext, GroupAccidentMasterPolicyContext {
    ...
    public void testPolicyRescindCancellation() {
        ...
        groupAccidentCertificatePolicy.cancel().perform(groupAccidentCertificatePolicy.getDefaultTestData(TestDataKey.CANCELLATION, "TestData_Plus2Months"));
        ...
        groupAccidentCertificatePolicy.rescindCancellation().perform(groupAccidentCertificatePolicy.getDefaultTestData(TestDataKey.RESCIND_CANCELLATION, TestDataKey.DEFAULT_TEST_DATA_KEY));
    ...
    public void testRollBackPolicyRescindCancellation() {
        ...
        groupAccidentCertificatePolicy.endorse().perform(groupAccidentCertificatePolicy.getDefaultTestData(TestDataKey.ENDORSEMENT, "TestData_Plus3Months"));

        String endorseEffectiveDate = groupAccidentCertificatePolicy.getDefaultTestData(TestDataKey.ENDORSEMENT, "TestData_Plus3Months").getValue(StartEndorsementActionTab.class.getSimpleName(),
        ...
        LOGGER.info("TEST: Cancelling Policy #" + policyNumber);
        groupAccidentCertificatePolicy.cancel().start();
        Page.dialogConfirmation.confirm();
        groupAccidentCertificatePolicy.cancel().getWorkspace().fill(groupAccidentCertificatePolicy.getDefaultTestData(TestDataKey.CANCELLATION, "TestData_Plus2Months"));
        groupAccidentCertificatePolicy.cancel().submit();
        assertThat(PolicySummaryPage.labelPolicyStatus).hasValue(ProductConstants.PolicyStatus.CANCELLATION_PENDING);
        assertThat(NavigationPage.comboBoxListAction.isOptionPresent(ActionConstants.ProductAction.CANCELLATION)).isFalse();
