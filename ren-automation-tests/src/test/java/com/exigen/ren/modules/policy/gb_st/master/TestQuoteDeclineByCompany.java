...
import static com.exigen.ren.main.enums.ProductConstants.PolicyStatus.COMPANY_DECLINED;
import static com.exigen.ren.utils.components.Components.POLICY_GROUPBENEFITS;
import static com.exigen.ren.utils.groups.Groups.*;

public class TestQuoteDeclineByCompany extends BaseTest implements CustomerContext, CaseProfileContext, StatutoryDisabilityInsuranceMasterPolicyContext {
    ...
    public void testQuoteDeclineByCompany() {
        ...
        EntitiesHolder.openCopiedMasterQuote(statutoryDisabilityInsuranceMasterPolicy.getType());
        ...
        statutoryDisabilityInsuranceMasterPolicy.declineByCompanyQuote().start();
        assertThat(statutoryDisabilityInsuranceMasterPolicy.declineByCompanyQuote().getWorkspace().getTab(DeclineByCompanyActionTab.class).getAssetList().getAsset(DeclineByCustomerActionTabMetaData.DECLINE_REASON))
                .containsAllOptions(PolicyConstants.PolicyDeclineReason.DECLINE_BY_COMPANY_REASONS);

        statutoryDisabilityInsuranceMasterPolicy.declineByCompanyQuote().getWorkspace().fill(statutoryDisabilityInsuranceMasterPolicy.getDefaultTestData(TestDataKey.DECLINE_BY_COMPANY, TestDataKey.DEFAULT_TEST_DATA_KEY));
        statutoryDisabilityInsuranceMasterPolicy.declineByCompanyQuote().submit();
