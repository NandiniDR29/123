...
import static com.exigen.ren.main.modules.policy.gb_eap.masterpolicy.metadata.PolicyInformationTabMetaData.CURRENT_POLICY_YEAR_START_DATE;
import static com.exigen.ren.main.modules.policy.gb_eap.masterpolicy.metadata.PolicyInformationTabMetaData.NEXT_POLICY_YEAR_START_DATE;
import static com.exigen.ren.utils.components.Components.POLICY_GROUPBENEFITS;
import static com.exigen.ren.utils.groups.Groups.*;

public class TestPolicyYearUpdateJobVerification extends BaseTest implements CustomerContext, CaseProfileContext, EmployeeAssistanceProgramMasterPolicyContext {
    ...
    public void policyYearUpdateJobVerification() {
        ...
        TextBox currentPolicyYearStartDate = policyInformationTab.getAssetList().getAsset(CURRENT_POLICY_YEAR_START_DATE);
        TextBox nextPolicyYearStartDate = policyInformationTab.getAssetList().getAsset(NEXT_POLICY_YEAR_START_DATE);
        ...
        employeeAssistanceProgramMasterPolicy.policyInquiry().start();
    ...
    private void masterPolicyCreation(LocalDateTime effectiveDate, LocalDateTime nextPolicyYearStartDate) {
        employeeAssistanceProgramMasterPolicy.createPolicyViaUI(getDefaultEAPMasterPolicyData()
                ...
                .adjust(TestData.makeKeyPath(policyInformationTab.getMetaKey(), NEXT_POLICY_YEAR_START_DATE.getLabel()),
