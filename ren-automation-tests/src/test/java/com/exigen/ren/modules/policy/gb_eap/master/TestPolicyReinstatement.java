...
public class TestPolicyReinstatement extends BaseTest implements CustomerContext, CaseProfileContext, EmployeeAssistanceProgramMasterPolicyContext {
    ...
    public void testPolicyReinstatement() {
        ...
        employeeAssistanceProgramMasterPolicy.reinstate().perform(employeeAssistanceProgramMasterPolicy.getDefaultTestData(TestDataKey.REINSTATEMENT, TestDataKey.DEFAULT_TEST_DATA_KEY));
