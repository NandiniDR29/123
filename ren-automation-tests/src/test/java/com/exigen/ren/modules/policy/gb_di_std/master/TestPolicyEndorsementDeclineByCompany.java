...
public class TestPolicyEndorsementDeclineByCompany extends BaseTest implements CustomerContext, CaseProfileContext, ShortTermDisabilityMasterPolicyContext {
    ...
    public void testPolicyEndorsementDeclineByCompany() {
        ...
        shortTermDisabilityMasterPolicy.declineByCompanyQuote().perform(shortTermDisabilityMasterPolicy.getDefaultTestData(TestDataKey.DECLINE_BY_COMPANY, TestDataKey.DEFAULT_TEST_DATA_KEY));
        PolicySummaryPage.buttonPendedEndorsement.click();
