...
public class TestPolicyRewriteToSameNumber extends BaseTest implements CustomerContext, CaseProfileContext, EmployeeAssistanceProgramMasterPolicyContext {
    ...
    public void testPolicyRewriteToSameNumber() {
        ...
        employeeAssistanceProgramMasterPolicy.createPolicy(getDefaultEAPMasterPolicySelfAdminData());

        String policyNumber = PolicySummaryPage.labelPolicyNumber.getValue();

        LOGGER.info("TEST: Cancellation Policy #" + policyNumber);
        employeeAssistanceProgramMasterPolicy.cancel().perform(employeeAssistanceProgramMasterPolicy.getDefaultTestData(TestDataKey.CANCELLATION, TestDataKey.DEFAULT_TEST_DATA_KEY));
        ...
        employeeAssistanceProgramMasterPolicy.createRewrite(employeeAssistanceProgramMasterPolicy.getDefaultTestData(TestDataKey.REWRITE, TestDataKey.DEFAULT_TEST_DATA_KEY)
                .adjust(employeeAssistanceProgramMasterPolicy.getDefaultTestData(TestDataKey.REWRITE, TestDataKey.DATA_GATHER).resolveLinks())
                .adjust(employeeAssistanceProgramMasterPolicy.getDefaultTestData(TestDataKey.ACCEPT_CONTRACT, TestDataKey.DEFAULT_TEST_DATA_KEY).resolveLinks())
        ...
        String rewriteEffectiveDate = employeeAssistanceProgramMasterPolicy.getDefaultTestData(TestDataKey.REWRITE, TestDataKey.DEFAULT_TEST_DATA_KEY).getValue(RewriteActionTab.class.getSimpleName(),
