...
public class TestPolicyYearUpdateJobVerification extends BaseTest implements CustomerContext, CaseProfileContext, StatutoryDisabilityInsuranceMasterPolicyContext {
    ...
    private void masterPolicyCreation(LocalDateTime effectiveDate, LocalDateTime nextPolicyYearStartDate) {
        statutoryDisabilityInsuranceMasterPolicy.createPolicyViaUI(getDefaultSTMasterPolicyData()
    ...
    private void performEndorsement(LocalDateTime endorsementDate) {
        statutoryDisabilityInsuranceMasterPolicy.createEndorsement(statutoryDisabilityInsuranceMasterPolicy.getDefaultTestData(TestDataKey.ENDORSEMENT, TestDataKey.DEFAULT_TEST_DATA_KEY)
                ...
                .adjust(statutoryDisabilityInsuranceMasterPolicy.getDefaultTestData(TestDataKey.DATA_GATHER, "TestDataUpdateSomething").resolveLinks())
