...
public class TestCustomerViewHistoryWithPreviousVersions extends CustomerBaseTest implements CustomerContext {
    ...
    public void testCustomerViewHistoryWithPreviousVersions() {
        ...
        customerIndividual.viewHistory().perform(tdCustomerIndividual.getTestData("ViewHistoryAction", "TestData"));

        assertThat(viewHistoryActionTab.getAssetList().getAsset(ViewHistoryActionTabMetaData.VERSION_DATE)).hasValue(
                tdCustomerIndividual.getValue("ViewHistoryAction", "TestData", viewHistoryActionTab.getMetaKey(),
                        ViewHistoryActionTabMetaData.VERSION_DATE.getLabel()));
        ...
        assertThat(ViewHistoryActionTab.tableGeneralInfo.getRow(4).getCell(2)).hasValue(tdSpecific().getValue("TestData", generalTab.getMetaKey(),
                GeneralTabMetaData.FIRST_NAME.getLabel()));
