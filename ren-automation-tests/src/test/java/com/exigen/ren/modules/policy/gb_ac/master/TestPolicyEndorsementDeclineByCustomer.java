...
public class TestPolicyEndorsementDeclineByCustomer extends BaseTest implements CustomerContext, CaseProfileContext, GroupAccidentMasterPolicyContext {
    ...
    public void testPolicyEndorsementDeclineByCustomer() {
        ...
        groupAccidentMasterPolicy.declineByCustomerQuote().perform(groupAccidentMasterPolicy.getDefaultTestData(TestDataKey.DECLINE_BY_CUSTOMER, TestDataKey.DEFAULT_TEST_DATA_KEY));
        PolicySummaryPage.buttonPendedEndorsement.click();
