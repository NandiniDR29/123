...
public class TestQuoteIssueSelfAdmin extends BaseTest implements CustomerContext, CaseProfileContext, LongTermDisabilityMasterPolicyContext {
    ...
    public void testQuoteIssueSelfAdmin() {
        ...
        longTermDisabilityMasterPolicy.createQuote(getDefaultLTDMasterPolicySelfAdminData());
