...
public class TestDxpEmployerCertificatePremiumSummaryLTD extends TestDxpEmployerCertificatePremiumSummaryBase implements CaseProfileContext,
        LongTermDisabilityMasterPolicyContext, LongTermDisabilityCertificatePolicyContext {

    @Test(groups = {DXP, REGRESSION, WITHOUT_TS})
    @TestInfo(testCaseId = "REN-35622", component = CUSTOMER_REST)
    public void testDxpEmployerCertificatePremiumSummaryLTD() {
        ...
        verifyResponse(DXPConstants.EmployerCertificatesPremium.CONFIG_LTD, "LTD");
    }
}
