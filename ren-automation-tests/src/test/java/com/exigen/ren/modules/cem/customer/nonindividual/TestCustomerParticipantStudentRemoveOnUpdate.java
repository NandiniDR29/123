...
public class TestCustomerParticipantStudentRemoveOnUpdate extends CustomerBaseTest {
    ...
    @TestInfo(testCaseId = "IPBQA-24906", component = CRM_CUSTOMER)
    public void testCustomerParticipantStudentRemoveOnUpdate() {
        ...
        assertThat(CustomerSummaryPage.tableStudentCensus).hasRows(1);

        LOGGER.info("TEST: Remove Participant on Update for Customer # " + customerNumber);
        customerNonIndividual.updateParticipantStudent().start(1);
        ...
        assertThat(CustomerSummaryPage.tableStudentCensus).isAbsent();
    }
}
