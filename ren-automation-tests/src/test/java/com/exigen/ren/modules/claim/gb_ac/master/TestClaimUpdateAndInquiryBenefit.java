...
public class TestClaimUpdateAndInquiryBenefit extends ClaimGroupBenefitsACBaseTest {
    ...
    public void testClaimUpdateAndInquiryBenefit() {
        ...
        ClaimAdjudicationBenefitPage.tableAllClaimBenefits.getRowContains(ClaimConstants.ClaimAllBenefitsTable.ASSOCIATED_PARTY,
                associatedParty).getCell(ClaimConstants.ClaimAllBenefitsTable.BENEFIT_NUMBER).controls.links.getFirst().click();
        ...
        String  updateAssociatedParty=tdClaim.getTestData("TestClaimUpdateAndInquiryBenefit", "TestData").getValue(BenefitAccidentalDeathDecedentTab.class.getSimpleName(),
                BenefitsAccidentalDeathDecedentTabMetaData.FIRST_NAME.getLabel());

        ClaimAdjudicationBenefitPage.tableAllClaimBenefits.getRowContains(ClaimConstants.ClaimAllBenefitsTable.ASSOCIATED_PARTY,
                updateAssociatedParty).getCell(ClaimConstants.ClaimAllBenefitsTable.BENEFIT_NUMBER).controls.links.getFirst().click();
        ClaimAdjudicationBenefitPage.linkBenefitInquiry.click();
