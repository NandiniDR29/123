...
public class TestPolicyReinstatement extends BaseTest implements CustomerContext, CaseProfileContext, LongTermDisabilityCertificatePolicyContext, LongTermDisabilityMasterPolicyContext {
    ...
    public void testPolicyReinstatement() {
        ...
        longTermDisabilityCertificatePolicy.reinstate().perform(longTermDisabilityCertificatePolicy.getDefaultTestData(TestDataKey.REINSTATEMENT, TestDataKey.DEFAULT_TEST_DATA_KEY));
