...
public class TestDxpEmployerCertificatePremiumSummaryVS extends TestDxpEmployerCertificatePremiumSummaryBase implements CaseProfileContext, GroupVisionMasterPolicyContext, GroupVisionCertificatePolicyContext{

    @Test(groups = {DXP, REGRESSION, WITHOUT_TS})
    @TestInfo(testCaseId = "REN-36597", component = CUSTOMER_REST)
    public void testDxpEmployerCertificatePremiumSummaryVS() {
        ...
        verifyResponse(DXPConstants.EmployerCertificatesPremium.CONFIG_VISION, CoveragesConstants.GroupVisionCoverages.VISION.toUpperCase());
    }
}
