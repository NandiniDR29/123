...
public class TestClaimNumberAPI extends ClaimGroupBenefitsACBaseTest implements ClaimRestContext {

    @Test(groups = {CLAIM_GB, REGRESSION, WITHOUT_TS})
    @TestInfo(testCaseId = "REN-23365", component = CLAIMS_GROUPBENEFITS)
    public void testClaimNumberAPI() {
        ...
        ResponseContainer<FNOLResponseModel> response = claimCoreRestService.postClaimFNOL(accHealthClaim.getGbACTestData().getTestData("REST", "Test_Data_FNOL")
