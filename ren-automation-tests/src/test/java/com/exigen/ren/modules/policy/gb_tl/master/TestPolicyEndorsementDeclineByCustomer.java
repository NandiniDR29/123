...
public class TestPolicyEndorsementDeclineByCustomer extends BaseTest implements CustomerContext, CaseProfileContext, TermLifeInsuranceMasterPolicyContext {
    ...
    public void testPolicyEndorsementDeclineByCustomer() {
        ...
        termLifeInsuranceMasterPolicy.declineByCustomerQuote().perform(termLifeInsuranceMasterPolicy.getDefaultTestData(TestDataKey.DECLINE_BY_CUSTOMER, TestDataKey.DEFAULT_TEST_DATA_KEY));
        PolicySummaryPage.buttonPendedEndorsement.click();
