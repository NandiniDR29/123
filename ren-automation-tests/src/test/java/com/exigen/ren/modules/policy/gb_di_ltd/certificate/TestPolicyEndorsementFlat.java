...
public class TestPolicyEndorsementFlat extends BaseTest implements CustomerContext, CaseProfileContext, LongTermDisabilityCertificatePolicyContext, LongTermDisabilityMasterPolicyContext {
    ...
    public void testPolicyEndorsementFlat() {
        ...
        longTermDisabilityCertificatePolicy.endorse().perform(longTermDisabilityCertificatePolicy.getDefaultTestData(TestDataKey.ENDORSEMENT, TestDataKey.DEFAULT_TEST_DATA_KEY));
        PolicySummaryPage.buttonPendedEndorsement.click();
        longTermDisabilityCertificatePolicy.dataGather().perform(tdSpecific().getTestData(TestDataKey.DEFAULT_TEST_DATA_KEY));
        PolicySummaryPage.buttonPendedEndorsement.click();
        longTermDisabilityCertificatePolicy.issue().perform(longTermDisabilityCertificatePolicy.getDefaultTestData(TestDataKey.ISSUE, TestDataKey.DEFAULT_TEST_DATA_KEY));
