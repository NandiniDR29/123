...
public class TestPolicyCancellationMidTerm extends BaseTest implements CustomerContext, CaseProfileContext, GroupVisionMasterPolicyContext {
    ...
    public void testPolicyCancellationMidTerm() {
        ...
        groupVisionMasterPolicy.createPolicy(getDefaultVSMasterPolicyData()
                .adjust(groupVisionMasterPolicy.getDefaultTestData(TestDataKey.DATA_GATHER, "Adjustment_BackDated").resolveLinks()));
