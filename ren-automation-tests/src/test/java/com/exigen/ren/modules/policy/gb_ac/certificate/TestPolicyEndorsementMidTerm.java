...
public class TestPolicyEndorsementMidTerm extends BaseTest implements CustomerContext, CaseProfileContext, GroupAccidentCertificatePolicyContext, GroupAccidentMasterPolicyContext {
    ...
    public void testPolicyEndorsementMidTerm() {
        ...
        groupAccidentMasterPolicy.createPolicy(getDefaultACMasterPolicyData()
                .adjust(groupAccidentMasterPolicy.getDefaultTestData(TestDataKey.DATA_GATHER, "Adjustment_BackDated"))
        ...
        groupAccidentCertificatePolicy.createPolicy(groupAccidentCertificatePolicy.getDefaultTestData(TestDataKey.DATA_GATHER, TestDataKey.DEFAULT_TEST_DATA_KEY)
                .adjust(groupAccidentCertificatePolicy.getDefaultTestData(TestDataKey.DATA_GATHER, "Adjustment_BackDated"))
