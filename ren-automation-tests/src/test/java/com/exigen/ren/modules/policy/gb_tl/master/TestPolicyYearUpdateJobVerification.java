...
public class TestPolicyYearUpdateJobVerification extends BaseTest implements CustomerContext, CaseProfileContext, TermLifeInsuranceMasterPolicyContext {
    ...
    private void performEndorsement(LocalDateTime endorsementDate) {
        termLifeInsuranceMasterPolicy.createEndorsement(termLifeInsuranceMasterPolicy.getDefaultTestData(TestDataKey.ENDORSEMENT, TestDataKey.DEFAULT_TEST_DATA_KEY)
                ...
                .adjust(termLifeInsuranceMasterPolicy.getDefaultTestData(TestDataKey.DATA_GATHER, "TestDataUpdateSomething").resolveLinks())
