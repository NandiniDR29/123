...
public class TestClaimAddSingleBenefitCalculations extends ClaimGroupBenefitsLTDBaseTest {
    ...
    public void testClaimAddSingleBenefitCalculations() {
        ...
        claim.calculateSingleBenefitAmount().perform(tdClaim.getTestData("CalculateASingleBenefitAmount", "TestData_LTD"), 2);
