...
public class TestPolicyRewriteToNewNumber extends BaseTest implements CustomerContext, CaseProfileContext, StatutoryDisabilityInsuranceMasterPolicyContext {
    ...
    public void testPolicyRewriteToNewNumber() {
        ...
        statutoryDisabilityInsuranceMasterPolicy.createRewrite(statutoryDisabilityInsuranceMasterPolicy.getDefaultTestData(TestDataKey.REWRITE, "TestDataNewNumber")
                .adjust(statutoryDisabilityInsuranceMasterPolicy.getDefaultTestData(TestDataKey.REWRITE, TestDataKey.DATA_GATHER).resolveLinks())
                .adjust(statutoryDisabilityInsuranceMasterPolicy.getDefaultTestData(TestDataKey.ACCEPT_CONTRACT, TestDataKey.DEFAULT_TEST_DATA_KEY).resolveLinks())
        ...
        String policyEffectiveDateRewritten = statutoryDisabilityInsuranceMasterPolicy.getDefaultTestData(TestDataKey.REWRITE, "TestDataNewNumber").getValue(RewriteActionTab.class.getSimpleName(),
