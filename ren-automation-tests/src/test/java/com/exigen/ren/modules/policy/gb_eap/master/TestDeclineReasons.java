...
public class TestDeclineReasons extends ScenarioTestDeclineReasons implements EmployeeAssistanceProgramMasterPolicyContext {
    ...
    public void testDeclineReasons() {
        super.testDeclineReasons(GroupBenefitsMasterPolicyType.GB_EAP, getDefaultEAPMasterPolicyData());
    }
}
