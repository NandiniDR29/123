...
public class TestPolicyReinstatement extends BaseTest implements CustomerContext, CaseProfileContext, TermLifeInsuranceMasterPolicyContext {
    ...
    public void testPolicyReinstatement() {
        ...
        termLifeInsuranceMasterPolicy.reinstate().perform(termLifeInsuranceMasterPolicy.getDefaultTestData(TestDataKey.REINSTATEMENT, TestDataKey.DEFAULT_TEST_DATA_KEY));
