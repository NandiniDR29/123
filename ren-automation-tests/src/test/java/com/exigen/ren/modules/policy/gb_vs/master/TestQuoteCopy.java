...
public class TestQuoteCopy extends BaseTest implements CustomerContext, CaseProfileContext, GroupVisionMasterPolicyContext {
    ...
    public void testQuoteCopy() {
        ...
        policyInformationTab.fillTab(getDefaultVSMasterPolicyData());
