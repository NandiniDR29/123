...
public class TestPolicyRescind extends BaseTest implements CustomerContext, CaseProfileContext, LongTermDisabilityCertificatePolicyContext, LongTermDisabilityMasterPolicyContext {
    ...
    public void testPolicyRescindCancellation() {
        ...
        longTermDisabilityCertificatePolicy.cancel().perform(longTermDisabilityCertificatePolicy.getDefaultTestData(TestDataKey.CANCELLATION, "TestData_Plus2Months"));
        ...
        longTermDisabilityCertificatePolicy.rescindCancellation().perform(longTermDisabilityCertificatePolicy.getDefaultTestData(TestDataKey.RESCIND_CANCELLATION, TestDataKey.DEFAULT_TEST_DATA_KEY));
    ...
    public void testRollBackPolicyRescindCancellation() {
        ...
        longTermDisabilityCertificatePolicy.endorse().perform(longTermDisabilityCertificatePolicy.getDefaultTestData(TestDataKey.ENDORSEMENT, "TestData_Plus3Months"));

        String endorseEffectiveDate = longTermDisabilityCertificatePolicy.getDefaultTestData(TestDataKey.ENDORSEMENT, "TestData_Plus3Months").getValue(StartEndorsementActionTab.class.getSimpleName(),
        ...
        LOGGER.info("TEST: Cancelling Policy #" + policyNumber);
        longTermDisabilityCertificatePolicy.cancel().start();
        Page.dialogConfirmation.confirm();
        longTermDisabilityCertificatePolicy.cancel().getWorkspace().fill(longTermDisabilityCertificatePolicy.getDefaultTestData(TestDataKey.CANCELLATION, "TestData_Plus2Months"));
        longTermDisabilityCertificatePolicy.cancel().submit();
        assertThat(PolicySummaryPage.labelPolicyStatus).hasValue(ProductConstants.PolicyStatus.CANCELLATION_PENDING);
        assertThat(NavigationPage.comboBoxListAction.isOptionPresent(ActionConstants.ProductAction.CANCELLATION)).isFalse();
