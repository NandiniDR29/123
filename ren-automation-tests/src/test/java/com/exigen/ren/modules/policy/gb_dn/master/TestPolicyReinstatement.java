...
public class TestPolicyReinstatement extends BaseTest implements CustomerContext, CaseProfileContext, GroupDentalMasterPolicyContext {
    ...
    public void testPolicyReinstatement() {
        ...
        groupDentalMasterPolicy.reinstate().perform(groupDentalMasterPolicy.getDefaultTestData(TestDataKey.REINSTATEMENT, TestDataKey.DEFAULT_TEST_DATA_KEY));
