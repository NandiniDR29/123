...
package com.exigen.ren.modules.claim.gb_st.without_policy;
...
public class TestClaimFicaMatchWithoutPolicy extends ClaimGroupBenefitsSTBaseTest {

    private final static List<String> FICA_MATCH_VALUES = ImmutableList.of("", "None", "Reimbursement", "Embedded", "Included", "Not Included");
    ...
    public void testClaimFicaMatch() {
        ...
        LOGGER.info("REN-14292, Steps 1-3");
        TestData defaultTd = disabilityClaim.getSTTestData().getTestData(TestDataKey.DATA_GATHER_WITHOUT_POLICY,
