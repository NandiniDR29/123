...
public class TestPolicyEndorsementDeletePending extends BaseTest implements CustomerContext, CaseProfileContext, GroupVisionMasterPolicyContext {

    @Test(groups = {GB, GB_PRECONFIGURED, GB_VS, WITHOUT_TS, REGRESSION})
    @TestInfo(testCaseId = {"IPBQA-24491", "REN-27899"}, component = POLICY_GROUPBENEFITS)
    public void testPolicyEndorsementDeletePending() {
        ...
        assertSoftly(softly -> {
            ...
            LOGGER.info("REN-27899 Step 2");
            AbstractContainer<?, ?> assetListForStartEndorsementActionTab = groupVisionMasterPolicy.endorse().getWorkspace().getTab(StartEndorsementActionTab.class).getAssetList();
            ...
            groupVisionMasterPolicy.deletePendedTransaction().perform(new SimpleDataProvider());
