...
public class TestDeclineReasons extends ScenarioTestDeclineReasons implements StatutoryDisabilityInsuranceMasterPolicyContext {
    ...
    public void testDeclineReasons() {
        super.testDeclineReasons(GroupBenefitsMasterPolicyType.GB_ST, getDefaultSTMasterPolicyData());
    }
