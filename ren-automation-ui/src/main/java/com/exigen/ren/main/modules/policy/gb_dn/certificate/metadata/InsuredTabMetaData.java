...
public class InsuredTabMetaData extends MetaData {
    ...
    public static final AssetDescriptor<AssetList> ADDRESS_INFORMATION = declare("Address Information", AssetList.class, InsuredTabMetaData.AddressInformationMetaData.class, By.xpath(Page.DEFAULT_ASSETLIST_CONTAINER));
    public static final AssetDescriptor<AssetList> RELATIONSHIP_INFORMATION = declare("Relationship Information", AssetList.class, InsuredTabMetaData.RelationshipInformationMetaData.class, By.xpath(Page.DEFAULT_ASSETLIST_CONTAINER));
