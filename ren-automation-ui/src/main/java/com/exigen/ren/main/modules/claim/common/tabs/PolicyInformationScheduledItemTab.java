...
public class PolicyInformationScheduledItemTab extends DefaultTab {
    ...
    public static Button buttonAddScheduledItem = new Button(By.xpath("//input[@value='Add Scheduled Item' or (@value='Add' and @id='policyDataGatherForm:addClaimsPolicyScheduledItem')]"));
